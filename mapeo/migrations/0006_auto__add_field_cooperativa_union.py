...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cooperativa.union'
        db.add_column('mapeo_cooperativa', 'union', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Uniones'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cooperativa.union'
        db.delete_column('mapeo_cooperativa', 'union_id')
