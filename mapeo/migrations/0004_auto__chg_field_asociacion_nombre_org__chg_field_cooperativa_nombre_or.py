...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asociacion.nombre_org'
        db.alter_column('mapeo_asociacion', 'nombre_org_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Centrales']))

        # Changing field 'Cooperativa.nombre_org'
        db.alter_column('mapeo_cooperativa', 'nombre_org_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Centrales'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Asociacion.nombre_org'
        db.alter_column('mapeo_asociacion', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['mapeo.Centrales']))

        # Changing field 'Cooperativa.nombre_org'
        db.alter_column('mapeo_cooperativa', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(default=1, to=orm['mapeo.Centrales']))
    ...
    models = {
        ...
        'mapeo.asociacion': {
            ...
            'municipio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lugar.Municipio']"}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'nombre_org': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mapeo.Centrales']"}),
        ...
        'mapeo.cooperativa': {
            ...
            'municipio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lugar.Municipio']"}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'nombre_org': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mapeo.Centrales']", 'null': 'True', 'blank': 'True'}),
            'num_hombres': ('django.db.models.fields.IntegerField', [], {}),
            'num_mujeres': ('django.db.models.fields.IntegerField', [], {}),
            'pagina_web': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'representante_legal': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
