...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cooperativa.nombre_org'
        db.delete_column('mapeo_cooperativa', 'nombre_org_id')

        # Adding field 'Cooperativa.central'
        db.add_column('mapeo_cooperativa', 'central', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Centrales'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Cooperativa.nombre_org'
        db.add_column('mapeo_cooperativa', 'nombre_org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Centrales'], null=True, blank=True), keep_default=False)

        # Deleting field 'Cooperativa.central'
        db.delete_column('mapeo_cooperativa', 'central_id')
