...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Familia.sexo'
        db.add_column('mapeo_familia', 'sexo', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Familia.fecha_nacimiento'
        db.add_column('mapeo_familia', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 2, 28)), keep_default=False)

        # Adding field 'Familia.cedula'
        db.add_column('mapeo_familia', 'cedula', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Familia.sexo'
        db.delete_column('mapeo_familia', 'sexo')

        # Deleting field 'Familia.fecha_nacimiento'
        db.delete_column('mapeo_familia', 'fecha_nacimiento')

        # Deleting field 'Familia.cedula'
        db.delete_column('mapeo_familia', 'cedula')
