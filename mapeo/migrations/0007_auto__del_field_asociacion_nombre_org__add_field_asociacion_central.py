...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Asociacion.nombre_org'
        db.delete_column('mapeo_asociacion', 'nombre_org_id')

        # Adding field 'Asociacion.central'
        db.add_column('mapeo_asociacion', 'central', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mapeo.Centrales']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Asociacion.nombre_org'
        db.add_column('mapeo_asociacion', 'nombre_org', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mapeo.Centrales']), keep_default=False)

        # Deleting field 'Asociacion.central'
        db.delete_column('mapeo_asociacion', 'central_id')
