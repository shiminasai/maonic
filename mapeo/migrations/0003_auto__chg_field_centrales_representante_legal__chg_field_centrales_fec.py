...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cooperativa.nombre_org'
        db.alter_column('mapeo_cooperativa', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['mapeo.Centrales'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Centrales.fecha_est'
        db.alter_column('mapeo_centrales', 'fecha_est', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 10, 11)))
        ...
        # Changing field 'Centrales.tipo_org'
        db.alter_column('mapeo_centrales', 'tipo_org_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mapeo.TipoOrganizacion']))
        ...
        # Changing field 'Uniones.fecha_est'
        db.alter_column('mapeo_uniones', 'fecha_est', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 10, 11)))
        ...
        # Changing field 'Uniones.tipo_org'
        db.alter_column('mapeo_uniones', 'tipo_org_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['mapeo.TipoOrganizacion']))

        # Changing field 'Uniones.representante_tecnico'
        db.alter_column('mapeo_uniones', 'representante_tecnico', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'AsistenciaTecnica.nombre_org'
        db.alter_column('mapeo_asistenciatecnica', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(default=4, to=orm['mapeo.Cooperativa']))

        # Changing field 'Cooperativa.representante_legal'
        db.alter_column('mapeo_cooperativa', 'representante_legal', self.gf('django.db.models.fields.CharField')(default=4, max_length=100))

        # Changing field 'Cooperativa.fecha_est'
        db.alter_column('mapeo_cooperativa', 'fecha_est', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 10, 11)))
        ...
        # Changing field 'Cooperativa.tipo_org'
        db.alter_column('mapeo_cooperativa', 'tipo_org_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['mapeo.TipoOrganizacion']))

        # Changing field 'Cooperativa.nombre_org'
        db.alter_column('mapeo_cooperativa', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(default='', to=orm['mapeo.Centrales']))
    ...
    models = {
        ...
        'mapeo.cooperativa': {
            ...
            'municipio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lugar.Municipio']"}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'nombre_org': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['mapeo.Centrales']", 'null': 'True', 'blank': 'True'}),
            'num_hombres': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'num_mujeres': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'pagina_web': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'representante_legal': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
