...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Familia.nombre_org'
        db.alter_column('mapeo_familia', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['mapeo.Cooperativa'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Familia.nombre_org'
        db.alter_column('mapeo_familia', 'nombre_org_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(default=4, to=orm['mapeo.Cooperativa']))
