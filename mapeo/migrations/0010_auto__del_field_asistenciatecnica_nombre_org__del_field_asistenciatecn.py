...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AsistenciaTecnica.nombre_org'
        db.delete_column('mapeo_asistenciatecnica', 'nombre_org_id')

        # Deleting field 'AsistenciaTecnica.tipo_org'
        db.delete_column('mapeo_asistenciatecnica', 'tipo_org_id')


    def backwards(self, orm):
        
        # Adding field 'AsistenciaTecnica.nombre_org'
        db.add_column('mapeo_asistenciatecnica', 'nombre_org', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['mapeo.Cooperativa'], null=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'AsistenciaTecnica.tipo_org'
        raise RuntimeError("Cannot reverse this migration. 'AsistenciaTecnica.tipo_org' and its values cannot be restored.")
