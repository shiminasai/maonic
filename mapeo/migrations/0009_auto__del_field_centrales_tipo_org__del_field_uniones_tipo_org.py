...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Centrales.tipo_org'
        db.delete_column('mapeo_centrales', 'tipo_org_id')

        # Deleting field 'Uniones.tipo_org'
        db.delete_column('mapeo_uniones', 'tipo_org_id')


    def backwards(self, orm):
        
        # Adding field 'Centrales.tipo_org'
        db.add_column('mapeo_centrales', 'tipo_org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.TipoOrganizacion'], null=True, blank=True), keep_default=False)

        # Adding field 'Uniones.tipo_org'
        db.add_column('mapeo_uniones', 'tipo_org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.TipoOrganizacion'], null=True, blank=True), keep_default=False)
