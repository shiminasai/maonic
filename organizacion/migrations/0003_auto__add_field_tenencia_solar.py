...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('organizacion_tenencia', 'solar', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tenencia.solar'
        db.delete_column('organizacion_tenencia', 'solar')
    ...
    models = {
        ...
        'organizacion.tenencia': {
            ...
            'solar': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }
