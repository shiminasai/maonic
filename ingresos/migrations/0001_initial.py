...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IngresoVendio'
        db.create_table('ingresos_ingresovendio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('ingresos', ['IngresoVendio'])

        # Adding model 'IngresoManeja'
        db.create_table('ingresos_ingresomaneja', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('ingresos', ['IngresoManeja'])

        # Adding model 'RubrosI'
        db.create_table('ingresos_rubrosi', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('ingresos', ['RubrosI'])

        # Adding model 'IngresoFamiliar'
        db.create_table('ingresos_ingresofamiliar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rubro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Rubros'])),
            ...
            ('quien_vendio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.IngresoVendio'], null=True, blank=True)),
            ('maneja_negocio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.IngresoManeja'], null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuestas.Encuesta'])),
        ))
        db.send_create_signal('ingresos', ['IngresoFamiliar'])
        ...
        db.create_table('ingresos_tipotrabajo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('ingresos', ['TipoTrabajo'])

        # Adding model 'OtrosIngresos'
        db.create_table('ingresos_otrosingresos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fuente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.Fuentes'])),
            ('tipo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.TipoTrabajo'], null=True, blank=True)),
            ...
            ('tiene_ingreso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.IngresoManeja'], null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuestas.Encuesta'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'IngresoVendio'
        db.delete_table('ingresos_ingresovendio')

        # Deleting model 'IngresoManeja'
        db.delete_table('ingresos_ingresomaneja')

        # Deleting model 'RubrosI'
        db.delete_table('ingresos_rubrosi')

        # Deleting model 'IngresoFamiliar'
        db.delete_table('ingresos_ingresofamiliar')

        # Deleting model 'Fuentes'
        db.delete_table('ingresos_fuentes')

        # Deleting model 'TipoTrabajo'
        db.delete_table('ingresos_tipotrabajo')
    ...
    models = {
        ...
        'ingresos.ingresofamiliar': {
            ...
            'rubro': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mapeo.Rubros']"})
        },
