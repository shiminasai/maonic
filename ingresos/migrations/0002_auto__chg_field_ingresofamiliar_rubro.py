...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IngresoFamiliar.rubro'
        db.alter_column('ingresos_ingresofamiliar', 'rubro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingresos.RubrosI']))


    def backwards(self, orm):
        
        # Changing field 'IngresoFamiliar.rubro'
        db.alter_column('ingresos_ingresofamiliar', 'rubro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Rubros']))
    ...
    models = {
        ...
        'mapeo.asociacion': {
            ...
            'central': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mapeo.Centrales']"}),
