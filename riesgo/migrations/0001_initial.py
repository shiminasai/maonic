...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Causa'
        db.create_table('riesgo_causa', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('riesgo', ['Causa'])

        # Adding model 'Fenomeno'
        db.create_table('riesgo_fenomeno', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('causa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riesgo.Causa'])),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('riesgo', ['Fenomeno'])

        # Adding model 'Graves'
        db.create_table('riesgo_graves', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('riesgo', ['Graves'])

        # Adding model 'Vulnerable'
        db.create_table('riesgo_vulnerable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('motivo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riesgo.Fenomeno'])),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuestas.Encuesta'])),
        ))
        db.send_create_signal('riesgo', ['Vulnerable'])

        # Adding M2M table for field respuesta on 'Vulnerable'
        db.create_table('riesgo_vulnerable_respuesta', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vulnerable', models.ForeignKey(orm['riesgo.vulnerable'], null=False)),
            ('graves', models.ForeignKey(orm['riesgo.graves'], null=False))
        ))
        db.create_unique('riesgo_vulnerable_respuesta', ['vulnerable_id', 'graves_id'])

        # Adding model 'PreguntaRiesgo'
        db.create_table('riesgo_preguntariesgo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('riesgo', ['PreguntaRiesgo'])

        # Adding model 'Riesgos'
        db.create_table('riesgo_riesgos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pregunta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riesgo.PreguntaRiesgo'], null=True, blank=True)),
            ('respuesta', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuestas.Encuesta'])),
        ))
        db.send_create_signal('riesgo', ['Riesgos'])


    def backwards(self, orm):
        
        # Deleting model 'Causa'
        db.delete_table('riesgo_causa')

        # Deleting model 'Fenomeno'
        db.delete_table('riesgo_fenomeno')

        # Deleting model 'Graves'
        db.delete_table('riesgo_graves')

        # Deleting model 'Vulnerable'
        db.delete_table('riesgo_vulnerable')

        # Removing M2M table for field respuesta on 'Vulnerable'
        db.delete_table('riesgo_vulnerable_respuesta')

        # Deleting model 'PreguntaRiesgo'
        db.delete_table('riesgo_preguntariesgo')

        # Deleting model 'Riesgos'
        db.delete_table('riesgo_riesgos')
    ...
    models = {
        ...
        'riesgo.fenomeno': {
            ...
            'causa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['riesgo.Causa']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'riesgo.graves': {
        ...
        'riesgo.riesgos': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pregunta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['riesgo.PreguntaRiesgo']", 'null': 'True', 'blank': 'True'}),
        ...
        'riesgo.vulnerable': {
            ...
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'motivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['riesgo.Fenomeno']"}),
            'respuesta': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['riesgo.Graves']", 'null': 'True', 'blank': 'True'})
        }
    }

    complete_apps = ['riesgo']
