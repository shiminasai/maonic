...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Certificacion.encuesta'
        db.add_column('riesgo_certificacion', 'encuesta', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['encuestas.Encuesta']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Certificacion.encuesta'
        db.delete_column('riesgo_certificacion', 'encuesta_id')
