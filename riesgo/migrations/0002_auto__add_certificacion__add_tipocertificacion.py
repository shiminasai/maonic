...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('riesgo_certificacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('riesgo', ['Certificacion'])

        # Adding M2M table for field certificacion_finca on 'Certificacion'
        db.create_table('riesgo_certificacion_certificacion_finca', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('certificacion', models.ForeignKey(orm['riesgo.certificacion'], null=False)),
            ('tipocertificacion', models.ForeignKey(orm['riesgo.tipocertificacion'], null=False))
        ))
        db.create_unique('riesgo_certificacion_certificacion_finca', ['certificacion_id', 'tipocertificacion_id'])

        # Adding model 'TipoCertificacion'
        db.create_table('riesgo_tipocertificacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('riesgo', ['TipoCertificacion'])


    def backwards(self, orm):
        
        # Deleting model 'Certificacion'
        db.delete_table('riesgo_certificacion')

        # Removing M2M table for field certificacion_finca on 'Certificacion'
        db.delete_table('riesgo_certificacion_certificacion_finca')

        # Deleting model 'TipoCertificacion'
        db.delete_table('riesgo_tipocertificacion')
    ...
    models = {
        ...
        'riesgo.certificacion': {
            'Meta': {'object_name': 'Certificacion'},
            'certificacion_finca': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['riesgo.TipoCertificacion']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'riesgo.fenomeno': {
