...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('semilla_cultivosvariedad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cultivo', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('semilla', ['CultivosVariedad'])

        # Adding model 'Variedades'
        db.create_table('semilla_variedades', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cultivo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semilla.CultivosVariedad'])),
            ('variedad', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('semilla', ['Variedades'])

        # Adding model 'UsoSemilla'
        db.create_table('semilla_usosemilla', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cultivo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semilla.Variedades'])),
        ...
        db.send_create_signal('semilla', ['UsoSemilla'])


    def backwards(self, orm):
        
        # Deleting model 'CultivosVariedad'
        db.delete_table('semilla_cultivosvariedad')

        # Deleting model 'Variedades'
        db.delete_table('semilla_variedades')

        # Deleting model 'UsoSemilla'
        db.delete_table('semilla_usosemilla')
    ...
    models = {
        ...
        'semilla.cultivosvariedad': {
            'Meta': {'object_name': 'CultivosVariedad'},
            'cultivo': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'semilla.usosemilla': {
            'Meta': {'object_name': 'UsoSemilla'},
            'cultivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['semilla.Variedades']"}),
        ...
        'semilla.variedades': {
            ...
            'cultivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['semilla.CultivosVariedad']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'variedad': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        }
    }

    complete_apps = ['semilla']
