...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DetalleCasa.lavadero'
        db.add_column('propiedades_detallecasa', 'lavadero', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DetalleCasa.lavadero'
        db.delete_column('propiedades_detallecasa', 'lavadero')
