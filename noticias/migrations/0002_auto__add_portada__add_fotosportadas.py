...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('noticias_portada', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('noticias', ['Portada'])

        # Adding model 'FotosPortadas'
        db.create_table('noticias_fotosportadas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('portada', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noticias.Portada'])),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('foto', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('noticias', ['FotosPortadas'])


    def backwards(self, orm):
        # Deleting model 'Portada'
        db.delete_table('noticias_portada')

        # Deleting model 'FotosPortadas'
        db.delete_table('noticias_fotosportadas')
