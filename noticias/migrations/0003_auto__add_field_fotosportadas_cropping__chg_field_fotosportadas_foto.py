...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FotosPortadas.cropping'
        db.add_column('noticias_fotosportadas', 'cropping',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'FotosPortadas.foto'
        db.alter_column('noticias_fotosportadas', 'foto', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'FotosPortadas.cropping'
        db.delete_column('noticias_fotosportadas', 'cropping')


        # Changing field 'FotosPortadas.foto'
        db.alter_column('noticias_fotosportadas', 'foto', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
