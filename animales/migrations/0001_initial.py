...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnimalesCantidad'
        db.create_table('animales_animalescantidad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('animales', ['AnimalesCantidad'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AnimalesCantidad'
        db.delete_table('animales_animalescantidad')
