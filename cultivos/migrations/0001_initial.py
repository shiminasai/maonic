...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Manejo'
        db.create_table('cultivos_manejo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('cultivos', ['Manejo'])
        ...
        db.create_table('cultivos_cultivosfinca', (
            ...
            ('manejo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cultivos.Manejo'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cultivos_manejo')
    ...
    models = {
        ...
        'cultivos.cultivosfinca': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manejo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cultivos.Manejo']"}),
