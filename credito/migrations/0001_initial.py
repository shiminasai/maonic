...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('credito_dacredito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('credito', ['DaCredito'])

        # Adding model 'OcupaCredito'
        db.create_table('credito_ocupacredito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('credito', ['OcupaCredito'])

        # Adding model 'Credito'
        db.create_table('credito_credito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('credito', ['Credito'])

        # Adding M2M table for field quien_credito on 'Credito'
        db.create_table('credito_credito_quien_credito', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('credito', models.ForeignKey(orm['credito.credito'], null=False)),
            ('dacredito', models.ForeignKey(orm['credito.dacredito'], null=False))
        ))
        db.create_unique('credito_credito_quien_credito', ['credito_id', 'dacredito_id'])

        # Adding M2M table for field ocupa_credito on 'Credito'
        db.create_table('credito_credito_ocupa_credito', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('credito', models.ForeignKey(orm['credito.credito'], null=False)),
            ('ocupacredito', models.ForeignKey(orm['credito.ocupacredito'], null=False))
        ))
        db.create_unique('credito_credito_ocupa_credito', ['credito_id', 'ocupacredito_id'])


    def backwards(self, orm):
        
        # Deleting model 'DaCredito'
        db.delete_table('credito_dacredito')

        # Deleting model 'OcupaCredito'
        db.delete_table('credito_ocupacredito')

        # Deleting model 'Credito'
        db.delete_table('credito_credito')

        # Removing M2M table for field quien_credito on 'Credito'
        db.delete_table('credito_credito_quien_credito')

        # Removing M2M table for field ocupa_credito on 'Credito'
        db.delete_table('credito_credito_ocupa_credito')
    ...
    models = {
        ...
        'credito.credito': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ocupa_credito': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['credito.OcupaCredito']", 'null': 'True', 'blank': 'True'}),
            'quien_credito': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['credito.DaCredito']", 'null': 'True', 'blank': 'True'}),
