...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FotoGalerias'
        db.create_table('galerias_fotogalerias', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('galeria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['galerias.Galeria'])),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('foto', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
        ))
        db.send_create_signal('galerias', ['FotoGalerias'])

    def backwards(self, orm):
        # Deleting model 'Galeria'
        db.delete_table('galerias_galeria')

        # Deleting model 'FotoGalerias'
        db.delete_table('galerias_fotogalerias')
    ...
    models = {
        ...
        'galerias.fotogalerias': {
            'Meta': {'object_name': 'FotoGalerias'},
            'foto': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
