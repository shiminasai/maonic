...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('publicaciones_publicacion', (
            ...
            ('categoria', self.gf('tagging_autocomplete.models.TagAutocompleteField')(max_length=255, null=True, blank=True)),
    ...
    models = {
        ...
        'publicaciones.publicacion': {
            ...
            'categoria': ('tagging_autocomplete.models.TagAutocompleteField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
