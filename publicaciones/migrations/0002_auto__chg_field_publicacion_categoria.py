...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publicacion.categoria'
        db.alter_column('publicaciones_publicacion', 'categoria', self.gf('tagging.fields.TagField')(null=True))
    def backwards(self, orm):

        # Changing field 'Publicacion.categoria'
        db.alter_column('publicaciones_publicacion', 'categoria', self.gf('tagging_autocomplete.models.TagAutocompleteField')(max_length=255, null=True))
    models = {
        'auth.group': {
