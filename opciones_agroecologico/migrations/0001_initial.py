...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('opciones_agroecologico_manejoagro', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('opciones_agroecologico', ['ManejoAgro'])

        # Adding model 'OpcionesManejo'
        db.create_table('opciones_agroecologico_opcionesmanejo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opciones_agroecologico.ManejoAgro'])),
        ...
        db.send_create_signal('opciones_agroecologico', ['OpcionesManejo'])


    def backwards(self, orm):
        
        # Deleting model 'ManejoAgro'
        db.delete_table('opciones_agroecologico_manejoagro')

        # Deleting model 'OpcionesManejo'
        db.delete_table('opciones_agroecologico_opcionesmanejo')
